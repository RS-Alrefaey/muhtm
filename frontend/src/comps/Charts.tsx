      ...
      <div className="flex flex-col w-full h-full px-8 py-1 space-y-6">
        <div className="flex justify-end items-center space-x-6">
          <div className="w-56 box-b relative flex justify-center">
            <h1 className="text-lg font-bold text-blue-950 font-cursive absolute top-2 left-32 ">
              رضا العملاء
            </h1>
        ...
        <div className="flex w-full h-3/4 box-b p-2 relative">
          <h1 className="text-lg font-bold text-blue-950 font-cursive absolute top-6 right-4">
