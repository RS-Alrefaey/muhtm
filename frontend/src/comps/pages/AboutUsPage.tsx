  ...
  return (
    <div className="w-full h-full flex flex-col justify-center font-cursive">
      <div className="light-blue-bg h-[300px] w-full flex justify-center relative">
        ...
        <div className="w-fit h-fit absolute top-32 left-[1000px]  p-10 flex justify-end ">
          <Title
            text={"من نحن ؟"}
            size="xl"
            desc="تعرف على المزيد عنا وعن فريقنا"
          />
        </div>
      </div>
      ...
      <div className="flex flex-col p-20">
        <h1 className="text-center text-5xl font-bold m-3 text-blue-950">
          رؤيتنا
        </h1>
        <h2 className="text-center text-xl font-bold m-3 text-blue-950">
          نحن نتصور مستقبلًا حيث يمكن للشركات تحديد الاتجاهات والمشاعر ومجالات
          التحسين بسهولة من مراجعات العملاء ، واستخدام هذه المعلومات لتحسين
          منتجاتهم وخدماتهم وتجربة العملاء بشكل عام. نتصور أيضًا مستقبلًا يشعر
          فيه العميل بأنه مسموع وقيم ، وحيث يمكن للشركات بناء علاقات قوية وطويلة
          الأمد مع عملائها من خلال الاستجابات الشخصية وفي الوقت المناسب
          لملاحظاتهم.
        </h2>
      </div>

      <div className="flex flex-col  justify-center light-blue-bg h-[300px] w-full">
        <h1 className="text-center text-blue-950 text-5xl font-bold mb-8">
          فريق مهتم
        </h1>
