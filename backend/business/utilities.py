...
# general_svm_model = load_model("models/general_svm_model.pkl")
general_svm_model = load_model(get_model_path("general_svm_model.pkl"))


# tfidf_3gram_vect = load_model("models/tfidf_3gram_vectorizer.pkl")
tfidf_3gram_vect = load_model(get_model_path("tfidf_3gram_vectorizer.pkl"))


ASPECTS = ["fabric", "size", "style", "color"]
# models = {aspect: load_model(f"models/{aspect}_svm_model.pkl") for aspect in ASPECTS}
models = {aspect: load_model(get_model_path(f"{aspect}_svm_model.pkl")) for aspect in ASPECTS}
